      ...
      <div className="md:ml-[80px]">
        <section className="container mx-auto px-4 md:px-8 py-10 dark:bg-neutral-800 dark:text-white space-y-8">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            <strong>Boole&apos;s Rule</strong> is a Newton-Cotes closed integration formula of degree 4. It approximates the definite integral <InlineMath math="\int_{a}^{b} f(x) \, dx" /> by interpolating the integrand with 4th-degree polynomials across groups of five points.
          </p>

          <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
            Boole&apos;s Rule offers an exceptionally high order of accuracy <InlineMath math="\mathcal{O}(h^6)" />. A mandatory requirement for Boole&apos;s Rule is that the number of subintervals <InlineMath math="n" /> <strong>must be a multiple of 4</strong> (e.g. <InlineMath math="n = 4, 8, 12" />).
          </p>

          {/* Formula Callout */}
          <div className="space-y-3">
            <p className="text-lg font-semibold text-gray-800 dark:text-gray-200">Formula for Boole&apos;s Rule:</p>
            <div className="w-full md:w-[80%] p-4 bg-blue-50/60 dark:bg-neutral-900 border-t-4 border-blue-600 dark:border-blue-500 border-x border-b border-gray-200 dark:border-neutral-700 rounded-b-xl rounded-t-sm shadow-sm overflow-x-auto text-center">
              <BlockMath math={`I = \\int_{a}^{b} f(x) \, dx \\approx \\frac{2h}{45} \\left[ 7y_0 + 32y_1 + 12y_2 + 32y_3 + 7y_4 \\right]`} />
            </div>
            <div className="space-y-2 text-lg text-gray-700 dark:text-gray-300 pl-4">
              ...
              <ul className="list-disc list-inside space-y-1 pl-2">
                ...
                <li><InlineMath math="y_0, y_1, y_2, y_3, y_4" /> are ordinates evaluated with weights <InlineMath math="(7, 32, 12, 32, 7)" />.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="w-full md:w-[80%] p-5 bg-emerald-50/60 dark:bg-neutral-900 border-t-4 border-emerald-600 dark:border-emerald-500 border-x border-b border-gray-200 dark:border-neutral-700 rounded-b-xl rounded-t-sm shadow-sm space-y-2 text-center">
              ...
              <BlockMath math={`\\int_{0}^{4} \\frac{1}{1 + x} \, dx`} />
              <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 pt-1">With <InlineMath math="n = 4 \text{ subintervals (multiple of 4)}" /></p>
            </div>
            ...
            <div className="space-y-2 py-1">
              ...
              <div className="w-full md:w-[80%] p-3 bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-lg shadow-sm text-center space-y-2">
                <BlockMath math={`x_0 = 0.0, \\quad x_1 = 1.0, \\quad x_2 = 2.0, \\quad x_3 = 3.0, \\quad x_4 = 4.0`} />
              </div>
            </div>
            ...
            <div className="space-y-2 py-1">
              ...
              <div className="w-full md:w-[80%] p-3 bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-lg shadow-sm text-center space-y-1">
                <BlockMath math={`y_0 = 1.0, \\quad y_1 = 0.5, \\quad y_2 = 0.3333`} />
                <BlockMath math={`y_3 = 0.25, \\quad y_4 = 0.20`} />
              </div>
            </div>
            ...
            <div className="space-y-2 py-1">
              ...
              <div className="w-full md:w-[80%] p-3 bg-gray-50 dark:bg-neutral-900 border border-gray-200 dark:border-neutral-700 rounded-lg shadow-sm text-center space-y-2">
                <BlockMath math={`I \\approx \\frac{2(1.0)}{45} \\left[ 7(1.0) + 32(0.5) + 12(0.3333) + 32(0.25) + 7(0.2) \\right]`} />
                <BlockMath math={`I \\approx \\frac{2}{45} \\left[ 36.40 \\right] \\approx 1.61778`} />
              </div>
            </div>
            ...
            <div className="w-full md:w-[80%] p-6 bg-emerald-50/70 dark:bg-emerald-950/30 border-t-4 border-emerald-600 dark:border-emerald-500 border-x border-b border-gray-200 dark:border-neutral-700 rounded-b-xl rounded-t-sm space-y-2">
              ...
              <BlockMath math={`\\boxed{\\int_{0}^{4} \\frac{1}{1 + x} \, dx \\approx 1.61778}`} />
              <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                Therefore, using <strong>Boole&apos;s Rule</strong> with <InlineMath math="n = 4" />, the approximate value of the integral is <strong>1.61778</strong> (exact value <InlineMath math="\ln 5 \approx 1.60944" />).
              </p>
            </div>
          </div>
